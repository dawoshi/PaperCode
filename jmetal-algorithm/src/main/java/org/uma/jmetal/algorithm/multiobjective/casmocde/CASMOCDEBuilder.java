...
public class CASMOCDEBuilder {
	 ...
	 */
	public CASMOCDEBuilder(Problem<DoubleSolution> problem,
	...
	public CASMOCDEBuilder setMaxEvaluations(int maxEvaluations) {
		if (maxEvaluations < 0) {
	...
	public CASMOCDEBuilder setPopulationSize(int populationSize) {
		if (populationSize < 0) {
	...
	public CASMOCDEBuilder setSelectionOperator(
	...
	public CASMOCDEBuilder setSolutionListEvaluator(
	...
	public AbstractCASMOCDE build() {
		AbstractCASMOCDE algorithm = null;
		algorithm = new AbstractCASMOCDE(problem, maxEvaluations,
