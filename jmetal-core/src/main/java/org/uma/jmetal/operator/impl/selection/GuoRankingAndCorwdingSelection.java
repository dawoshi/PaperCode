...
import org.uma.jmetal.util.solutionattribute.impl.guoDominanceRanking;
...
public class GuoRankingAndCorwdingSelection<S extends Solution<?>>
...
/** Constructor */
  public GuoRankingAndCorwdingSelection(int solutionsToSelect,Double value) {
  ...
  public List<S> execute(List<S> solutionList) throws JMetalException {
    ...
    Ranking<S> ranking = new guoDominanceRanking<S>(getValue());
