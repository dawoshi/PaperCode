...
public class ENSEMBLERunner extends AbstractAlgorithmRunner {
	public static void main(String[] args) throws JMetalException,
			FileNotFoundException {
		Problem<DoubleSolution> problem;
		AbstractENSEMBLE algorithm;
		...
		algorithm = new AbstractENSEMBLE(problem, maxEvaluations,populationSize, crossover, mutation,selection, evaluator);
		algorithm.run();
