...
import org.uma.jmetal.algorithm.multiobjective.gsssmocde.AbstractGSSSMOCDE;
...
public class GSSSMOCDERunner extends AbstractAlgorithmRunner {
	public static void main(String[] args) throws JMetalException,
			FileNotFoundException {
		Problem<DoubleSolution> problem;
		AbstractGSSSMOCDE algorithm;
		...
		algorithm = new AbstractGSSSMOCDE(problem, maxEvaluations,populationSize, crossover, mutation,selection, evaluator);
		algorithm.setValue(value);
		algorithm.run();
